...
if app_mode == 'About App':
    ...
    st.markdown('In this application we are using **MediaPipe** for detecting Sign Language. **SpeechRecognition** '
                'Library of python to recognise the voice and machine learning algorithm which convert speech to the '
                'Indian Sign Language .**StreamLit** is to create the Web Graphical User Interface (GUI) ')
    st.markdown("""
    <style>
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child {
        width: 400px;
        ...
        if results.multi_hand_landmarks:
            for hand_landmark in results.multi_hand_landmarks:
                ...
                if lm_list[2].x > lm_list[4].x and lm_list[8].y > lm_list[6].y and lm_list[12].y < lm_list[10].y and \
                    ...
                    if lm_list[4].x > lm_list[19].x and lm_list[8].y < lm_list[6].y and lm_list[12].y > lm_list[
                        10].y and \
                            lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                    ...
                    if lm_list[4].x < lm_list[10].x and lm_list[8].y < lm_list[6].y and lm_list[12].y < lm_list[
                        ...
                        # L
                        if lm_list[3].x > lm_list[4].x and lm_list[7].y > lm_list[8].y and lm_list[5].y >= lm_list[
                            10].y and \
                                lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                        ...
                        if lm_list[4].x > lm_list[10].x and lm_list[8].y > lm_list[6].y and lm_list[12].y > lm_list[
                            ...
                            if lm_list[4].x > lm_list[3].x and lm_list[7].y <= lm_list[11].y and lm_list[12].y < \
                                    lm_list[
                                        10].y and \
                            ...
                            if lm_list[4].x < lm_list[3].x and lm_list[8].y < lm_list[6].y and lm_list[12].y > lm_list[
                                10].y and \
                                    lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                                cv2.putText(img, "S", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                                my_list.append("S")

                            if lm_list[4].x <= lm_list[10].x and lm_list[8].y < lm_list[6].y and lm_list[12].y > \
                                    lm_list[
                                        10].y and \
                                    lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                        ...
                        if lm_list[4].x > lm_list[3].x and lm_list[8].y < lm_list[6].y and lm_list[7].y >= lm_list[
                            11].y and \
                                lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                            cv2.putText(img, "U", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                            my_list.append("U")

                        if lm_list[4].x > lm_list[3].x and lm_list[8].y < lm_list[6].y and lm_list[11].y > lm_list[
                            12].y and \
                                lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                            cv2.putText(img, "V", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                            my_list.append("V")

                        if lm_list[19].x > lm_list[4].x and lm_list[8].y < lm_list[6].y and lm_list[12].y < lm_list[
                            10].y and \
                                lm_list[16].y < lm_list[14].y and lm_list[19].y > lm_list[17].y:
                            cv2.putText(img, "W", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                            my_list.append("W")

                        if lm_list[4].x > lm_list[3].x and lm_list[8].y < lm_list[7].y and lm_list[12].y > lm_list[
                            10].y and \
                                lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y:
                            cv2.putText(img, "X", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                            my_list.append("X")

                        if lm_list[3].x > lm_list[4].x and lm_list[8].y > lm_list[7].y and lm_list[12].y > lm_list[
                            11].y and \
